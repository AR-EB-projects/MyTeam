              ...
              <div className="why-text-col">
                ...
                <div className="why-quote-box">
                  <p className="why-quote-text">
                    "Ние бяхме в капана на хартиените дневници, изгубената информация и безкрайните Viber групи - и създадохме изход. МуТет е проектиран от хора, които са били точно там, където сте Вие cera."
                  </p>
                </div>
              </div>
