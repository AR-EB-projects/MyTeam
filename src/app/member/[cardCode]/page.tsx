      ...
      <div className="page-inner">
        ...
        <div className="card-shell">
          ...
          <div className="card-body">
            ...
            {/* ── Sport Depot discount button — admin/coach preview only ── */}
            {(isAdmin || isCoach) && (
              <button
              ...
              >
                <img src="/ats-logo.png" alt="Absolute Teamsport" className="sd-discount-logo" />
                <span className="sd-discount-label">Вашата отстъпка</span>
          ...
          <div className="pm-overlay sd-overlay" onClick={() => setSportDepotModalOpen(false)}>
            <div className="sd-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="sd-modal-header">
                <img src="/ats-logo.png" alt="Absolute Teamsport" className="sd-modal-logo" />
